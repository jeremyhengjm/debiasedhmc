...
load("inst/coxprocess/rm.hmc.contraction.parameters.RData")
...
for (iparameter in 1:nrow(contraction.df)){
  ...
  for (ijob in 1:njobs){
    filename <- paste("inst/coxprocess/output/output.rm.hmc.parameter", iparameter, ".rep", ijob, ".RData", sep = "")
    load(file = filename)
  ...
  combined_filename <- paste("inst/coxprocess/output/output.rm.hmc.parameter", iparameter, ".RData", sep = "")
...
grid.arrange(arrangeGrob(ghist[[1]], ghist[[2]], ghist[[3]],
                         ...
                         nrow = 3, ncol = 2))
grid.arrange(arrangeGrob(ghist[[7]], ghist[[8]], ghist[[9]],
                         ghist[[10]], ghist[[11]], ghist[[12]],
                         nrow = 3, ncol = 2))
grid.arrange(arrangeGrob(ghist[[13]], ghist[[14]], ghist[[15]],
                         ghist[[16]], ghist[[17]], ghist[[18]],
                         nrow = 3, ncol = 2))
grid.arrange(arrangeGrob(ghist[[19]], ghist[[20]], ghist[[21]],
                         ghist[[22]], ghist[[23]],
                         nrow = 3, ncol = 2))

# g_filename <- paste("inst/coxprocess/plots/rm.hmc.meetingtimes.pdf")
...
grid.arrange(arrangeGrob(gdistance[[1]], gdistance[[2]], gdistance[[3]],
                         ...
                         nrow = 3, ncol = 2))
grid.arrange(arrangeGrob(gdistance[[7]], gdistance[[8]], gdistance[[9]],
                         gdistance[[10]], gdistance[[11]], gdistance[[12]],
                         nrow = 3, ncol = 2))
grid.arrange(arrangeGrob(gdistance[[13]], gdistance[[14]], gdistance[[15]],
                         gdistance[[16]], gdistance[[17]], gdistance[[18]],
                         nrow = 3, ncol = 2))
grid.arrange(arrangeGrob(gdistance[[19]], gdistance[[20]], gdistance[[21]],
                         gdistance[[22]], gdistance[[23]],
                         nrow = 3, ncol = 2))
# g_filename <- paste("inst/coxprocess/plots/rm.hmc.distance.pdf")
# ggsave(filename = g_filename, plot = g, width = 9, height = 6)
