...
nsteps <- contraction.df$nsteps[iparameter] # L = 1, 10, 20, 30 takes c(0.0185, 0.0865, 0.16, 0.23) seconds per mcmc iteration
...
filename <- paste("output.hmc.germancredit.parameter", iparameter, ".RData", sep = "")
